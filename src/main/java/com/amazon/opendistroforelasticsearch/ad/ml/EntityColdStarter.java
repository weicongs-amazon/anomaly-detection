...
public class EntityColdStarter {
    ...
    public EntityColdStarter(
        ...
        CacheLoader<String, Instant> loader = new CacheLoader<String, Instant>() {
            @Override
            public Instant load(String modelId) {
     ...
     */
    public double[] trainRCFModel(double[][] dataPoints, String modelId, RandomCutForest rcf) {
